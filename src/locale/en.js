export const messages = {
  en: {
    ...
    job: {
      ...
      link: `<a href="mailto:https://master-doomxii.web.app/en/home" target="_blank">
        luxiarysocial@gmail.com
      </a>
      `,
    ...
    addTo: {
      ...
      card1: {
        ...
        step: {
          ...
          _2: `2. Next, go to <a
          href="https://master-doomxii.web.app/"
          target="_blank"
        >master-doomxii.web.app</a>.`,
    ...
    news: {
      head: '-News-',
      title: 'Stay up to date <br> with updates.',
      sub: 'Read the newest changes and learn more.',
      descr: "We have embarked on one of the most exciting adventures for the digital world and we're looking for talented and passionate people to sail with us!",
      descr_sub: `Technology, design, marketing, finance, media, you name it.
      Do you believe in Luxiary, a better future for social networks and humanity as a whole?
  ...
  de: {
    ...
    job: {
      ...
      descr_sub: `echnologie, Design, Ideen, Medien, Sie nennen es. Glauben Sie an mich? Senden Sie mir Ihre Jobdetails an`,
      link: `<a href="mailto:https://master-doomxii.web.app/en/home" target="_blank">
        luxiarysocial@gmail.com
      </a>
      `,
