...
const job = () => import("./views/Job/jobs.vue");
const addTo = () => import("./views/AddToHomescreen/addHomescreen.vue");
const passion = () => import("./views/OurPassion/passion.vue");
const news = () => import("./views/NewsFeed/news.vue");
